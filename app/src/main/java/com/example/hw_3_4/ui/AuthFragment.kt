...
import com.example.hw_3_4.databinding.FragmentAuthBinding
import com.example.hw_3_4.ui.notifications.AUTH_TYPES
...
class AuthFragment : Fragment() {
    ...
    private fun setupGoogleSignIn() {
        gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken("474925745848-pvmm14okk8rc0jg8av229t9kssd4kada.apps.googleusercontent.com")
            .requestEmail()
            .build()
